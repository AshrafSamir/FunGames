    ...
    inter = setInterval(
        function () {
            ...
            if (topBallIntValue == 369) {
                if (hitedBallValue - 20 < leftBallIntValue && hitedBallValue + 100 > leftBallIntValue) {
                    checkHeight = true
                ...
                for (let i = 0; i < hitted.length; i++) {
                    ...
                    if (hitted[i].style.display != "none" && parseInt(getComputedStyle(hitted[i]).top) == 52 && leftBallIntValue > parseInt(getComputedStyle(hitted[i]).left) && leftBallIntValue < parseInt(getComputedStyle(hitted[i]).left) + 50) {
                        hitted[i].style.display = "none";
                        console.log('hit first row')
                        checkHeight = false
                    }
                ...
                for (let i = 0; i < hitted.length; i++) {
                    //console.log(parseInt(getComputedStyle(hitted[i]).left))
                    if (hitted[i].style.display != "none" && parseInt(getComputedStyle(hitted[i]).top) == 2 && leftBallIntValue > parseInt(getComputedStyle(hitted[i]).left) && leftBallIntValue < parseInt(getComputedStyle(hitted[i]).left) + 50) {
                        hitted[i].style.display = "none";
                        checkHeight = false
            ...
            for (let i = 0; i < hitted.length; i++) {
                ...
                if (hitted[i].style.display != "none" && topBallIntValue > 2 && topBallIntValue < 22 && (parseInt(getComputedStyle(hitted[i]).left) == parseInt(getComputedStyle(ball).left) + 20 || parseInt(getComputedStyle(hitted[i]).left) + 52 == parseInt(getComputedStyle(ball).left))) 
                {
                    // console.log(i+'  right div  ' +  parseInt(getComputedStyle(hitted[i]).right))
                    console.log(i + '  left div  ' + parseInt(getComputedStyle(hitted[i]).left))
                    console.log(i + '  right ball  ' + parseInt(getComputedStyle(ball).right))
